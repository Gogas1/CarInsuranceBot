...
{
    internal class PassportProcessingCallbackQueryAction : CallbackQueryActionBase
    {
        public PassportProcessingCallbackQueryAction(UserService userService, ITelegramBotClient botClient) : base(userService, botClient)
        {
        }
