...
namespace CarInsuranceBot.Core.Actions.DefaultActions
{
    ...
    /// </summary>
    internal class DefaultMessageAction : MessageActionBase
    {

        private readonly OpenAIService _openAiService;

        public DefaultMessageAction(UserService userService, ITelegramBotClient botClient, OpenAIService openAiService) : base(userService, botClient)
        {
